...
const MODULOS = [
  ...
  { id: 15, key: "manifiestos", nombre: "Asignar Pallets", sub: "Embarques", icono: PackagePlus, desc: "Arma la Orden de Venta para embarque con pallets reales de SAP (escaneo, rango y selección múltiple). Se guarda primero en la app; cuando esté lista, la mandas a SAP con un botón desde la pestaña 'Órdenes de venta'." },

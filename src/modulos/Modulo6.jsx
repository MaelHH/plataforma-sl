  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <div>
<h1 className="text-base font-semibold text-gray-900">Módulo 6 — Consolidado Cristina</h1>
          <p className="text-sm text-gray-500 mt-0.5">División de facturas por empresa · interfaz SAP</p>        </div>
